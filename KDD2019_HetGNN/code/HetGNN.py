...
class model_class(object):
    def __init__(self, args):
        ...
        feature_list = [input_data.p_abstract_embed, input_data.p_title_embed, input_data.p_v_net_embed,
                        input_data.p_a_net_embed, input_data.p_ref_net_embed,
                        input_data.p_net_embed, input_data.a_net_embed, input_data.a_text_embed, input_data.v_net_embed,
